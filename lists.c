...
/**
 * addNode - Node to the start of the list
...
/**
 * addNodeEnd - Adds node to the end of the list
 * @head: Address of pointer to head node
 * @str: Str field of node
 ...
 * @h: It's the pointer to first node
 *
 * Return: It's the size of list
 */
 ...
 * @index: It's the index of node to delete
 *
...
/**
 * freeList - It frees all nodes of a list
 * @head_ptr: It's the address of pointer to head node
 *
 * Return: void
 */
